    ...
    <tbody>
       <tr>
            ...
            <td>
                ...
                <input type="text" id="txt_responsibility_1" name="txt_responsibility_1" placeholder="Select Vehicle Brand" autocomplete="off" onfocus="get_all_vehicle_brand1();"/>
                <input type="hidden" id="txt_responsibility_id_1" name="txt_responsibility_id_1"/>
            </td>
            <td>
                
                <input type="text" id="txt_follow_up_1" name="txt_follow_up_1" placeholder="Select Vehicle Repair Type" autocomplete="off" onfocus="get_all_vehicle_repair1();"/>
