...
function enter_sp_target(id) {
    ...
    $j('#entr_sp_target').html(
            ...
            + '<td><input type="text" name="qty' + id + '_1" id="qty' + id + '_1" onkeyup="create_total_quantity('+id+');"></td>'
...
function addRow(idd, x, y) {
    ...
    $j('#tbl_sp_target').append(
            ...
            + '<td><input type="text" name="qty' + x + '_' + id + '" id="qty' + x + '_' + id + '" onkeyup="create_total_quantity(' + x + ');"></td>'
...
function add_row(idd, y) {
    ...
    $j('#tbdy_sp').append(
            ...
            + '<td><input type="text" id="proposed_qty' + id + '" name="proposed_qty' + id + '" onclick="enter_sp_target(' + id + ');"></td>'
