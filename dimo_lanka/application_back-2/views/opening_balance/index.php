...
<table class="sub-table" id="openning_bal" border="0">
    <thead>
        <tr>
            ...
            <td class="sub-table-title" width="30%">Product Name</td>
            <td class="sub-table-title" width="20%">Category</td>
            <td class="sub-table-title" width="15%">Product Code</td>
            <td class="sub-table-title" width="15%">Price</td>
            <td class="sub-table-title" width="10%">Qty</td>
            <td class="sub-table-title" width="10%">Expiry Date</td>
            <td class="sub-table-title" width="10%">Amount</td>
        </tr>
    </thead>
    <tbody>
        <tr id="1">
            ...
            <td width="25%">
                <input type="text"  id="autoproduct_name_11" name="autoproduct_name_11" style="width:85%" onkeyup="get_pname(1);"/>
                <input type="hidden"  id="product_name_11"  name="product_name_11"  style="width:85%" /></td>
            <td width="10%">
               
                <input type="text"  id="item_cat_1" name="item_cat_1" style="width:95%"/>
                
                <input type="hidden"  id="item_cat_11"  name="item_cat_11"  style="width:95%" /></td>
                </td>
                <td width="10%">
                <input type="hidden" id="product_id_1" name="product_id_1"  style="width:10%" readonly="readonly"  />
                <input type="text" id="product_code_1" name="product_code_1"  style="width:70%" readonly="readonly"  />
                
            </td>
            <td width="10%"><input type="text" value="0.00" style="width:70%" id="price_1" name="price_1" onkeyup="calculateTotal(1);" readonly="readonly"/></td>
            <td width="10%"><input type="text" value="0"  style="width:70%" id="qty_1"  name="qty_1" onkeyup="calculateTotal(1);"/></td>
            <td ><input type='text' id='date_1' name='date_1'  style='width:90%;text-align:right'  value='' onmouseover='setDate(this.id);'/> </td>
            <td>
