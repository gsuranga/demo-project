...
<!--                    <td><?php echo $value->delar_shop_name; ?></td>-->
                    ...
                    <td>
<!--
                        <a style="text-decoration: none;" href="drawIndexupdatemoredetails?tokendealer_id=<?php echo $value->delar_id; ?>"><img width="20" height="20" src="<?php echo $System['URL']; ?>public/images/edit.png"></a>-->
