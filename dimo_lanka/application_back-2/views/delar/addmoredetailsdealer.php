...
<body>
    ...
    <table width="70%">
        <tr>
            ...
            <td> <input type="text" name="delar_name" id="delar_name">
    ...
    <table width="100%" cellsapcing="3" cellpadding="3">
        ...
        <table width="50%">
            <tr>
                ...
                <td> <input type="text" style="width: 60%" id="delar_shop_name" name="delar_shop_name">
