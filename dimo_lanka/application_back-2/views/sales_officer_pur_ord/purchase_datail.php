...
<?php echo form_open('sales_officer_pur_ord/addPurchaseOrder'); ?>
<?php ?>
<table width="100%">
        ...
        <td>
            <table>
                <tr >
                    ...
                    <td></td>
                    <td style="text-align: center;color: #3399CC">Sales Officer  </td>
                </tr>
                <tr>
                    
                    <td>Account No </td>
                    <td style="border-color: blue"><?php echo form_input($sales_account_no) ?></td>
                    <td>Name </td>

                    <td><input type="text" readonly="true" id="salesofficerNameForCreate"></></td>
                    <td><div style="height: 100px;width: 1px;background: blue"></div> </td>
                </tr>
        ...
        <td>
            <table border="0"width="100%">
                ...
                <tbody>
                    <tr>
                        <td></td>
                        <td align="right"><input type="button" value="History" onclick="showhistory();"></></td>
                    </tr>
                    <tr>
                        <td>Total Amount</td>
                        <td><?php echo form_input($total_amount) ?></td>
                    </tr>
                    <tr>
                        <td>Total Discount</td>
                        <td><?php echo form_input($total_discount) ?></td>
                    </tr>
        ...
        <table width="100%" class="SytemTable" align="center" id="tbl_purchaseorder" cellpadding="10">
            ...
            <tbody id="tbody1">
                <tr  name="1" id="1">
                    ...
                    <td><input  id="des_1" name="des_1" type="text" readonly="true"></input></td>
