...
class reports extends C_Controller {
    ...
    private $resours = array(
        'JS' => array('reports/js/reports', 'reports/dealer_ranking/js/jquery.mtz.monthpicker', 'reports/dealer_ranking/js/getSales', 'reports/salesman_wise_summary/js/salesman_summary', 'reports/field_sales_report/js/report_js', 'reports/target_part_number_wise_overall/js/sales_report', 'reports/sales_officer_monthly_target/js/sales_report_monthly', 'reports/loss_sales/js/loss_sales', 'reports/dealers_sales_report/js/dealer_sales_report', 'reports/dealers_all_sales_report/js/dealers_all_sales_report',
            'reports/dlr_report/js/dlr', 'reports/dealer_wise_target/js/dealer_target'),
