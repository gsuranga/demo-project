...
<!--  edited  12:41 PM 10/12/2015                 <td style="text-align: right;"><?php //echo $value->cash_payment ?></td>
                    ...
                    <td><?php echo $value->due_date ?></td>
                     <td style="text-align: right;"><?php echo $value->tgt_collection_dt ?></td>
                    <td align="center"><a style="text-decoration: none;"  href="drawIndexPayments?stoken=<?php echo md5(time()); ?>&token_delar_deliver_order_id=<?php echo $value->deliver_order_id ?>&token_tar_date=<?php echo $value->tgt_collection_dt ?>&amount=<?php echo $value->total_amount; ?>&token_wip_no=<?php echo $value->wip_no; ?>&token_invoice_no=<?php echo $value->invoice_no; ?>"><img width="20" height="20" src="<?php echo $System['URL']; ?>public/images/gold-coin-md.png"></a></td>     
                </tr>
                <?php
            }
        }
