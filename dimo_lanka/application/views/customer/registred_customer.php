...
<!--                    <td width="170"><label style="font-size: 14px;">Add Driver/Drivers:-</label></td>-->
    ...
    <tr align="right">
        ...
        <td><input type="text" id="owner" name="owner" placeholder="Owner Name" autocomplete="off" onclick="get_owner();">
            <input type="hidden" id="owner_id" name="owner_id" placeholder="Owner Name" autocoowner_idmplete="off"></td>
        <td><input type="text" id="ownerConNo" name="ownerConNo" placeholder="Owner Contact No" autocomplete="off">
            <input type="hidden" id="ownerConNo_id" name="ownerConNo_id" placeholder="Owner Name" autocomplete="off"></td>
        <td><input type="text" id="ownerEmail" name="ownerEmail" placeholder="Owner Email" autocomplete="off">
            <input type="hidden" id="ownerEmail_id" name="ownerEmail_id" placeholder="Owner Email" autocomplete="off"></td>
    </tr>
...
<!--                    <td width="170"><label style="font-size: 14px;">Add Driver/Drivers:-</label></td>-->
        ...
        <td width="170"><label style="font-size: 14px;">Name of Dealers</label></td>
    ...
    <tr align="right">
        ...
        <td>
            ...
            <select id="dealer_select_1" name="dealer_select_1" >  </select>
        </td>
...
<!--            <input type="hidden" id="dealer_name_id_1" name="dealer_name_id_1" size="10px" autocomplete="off">-->
        ...
        <td>
            <input type="text" id="garage_name_1" name="garage_name_1" size="10px" autocomplete="off" > <!-- onclick="get_garage1();" -->
<!--            <input type="hidden" id="garage_name_id_1" name="garage_name_id_1" size="10px" autocomplete="off">-->
        </td>
    </tr>
    <input type="hidden" id="token_dealer_no_" name="token_dealer_no_" value="1"/>
    <tr>
        <td></td>
        <td><?php echo form_error('driver_name_0'); ?></td>
    </tr>
...
<table align="center">
    <tr>
        <td></td>
        <td></td>
        <td><?php echo form_input($btn_sub); ?></td>
