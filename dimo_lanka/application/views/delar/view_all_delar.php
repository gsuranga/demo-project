...
<!--                    <td><?php echo $value->delar_shop_name; ?></td>-->
                    ...
                    <td align="center"><img src="<?php echo $System['URL']; ?>public/images/more.png" style="widh:50px;height:10px;cursor:pointer" onclick="view_order1(<?php echo $value->delar_id; ?>);"></td>
