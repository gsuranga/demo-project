        ...
        if ($extraData != '') {
            ...
            foreach ($extraData as $value) {
                ...
                <tr>
                    ...
                    <td><?php 
                    if(isset($value->log ) && $value->log !='' ){
                        echo $value->new.'&nbsp&nbsp';
                       echo 'Mr.'.$value->log; 
                    }else{
                        echo '-';
                    }
                    ...
                    <td><a style="text-decoration: none;" href = "JavaScript:newPopup('drawIndexPurchaseOrderDetails?token_purchase_order_iD=<?php echo $value->purchase_order_id; ?>&token_amount=<?php echo $value->amount; ?>&token_dNum=<?php echo $value->delar_num; ?>&account_no=<?php echo $value->delar_account_no; ?>&dealer_id=<?php echo $value->delar_id ?>&dealer_name=<?php echo $value->delar_shop_name ?>&p_o_no=<?php echo $value->purchase_order_number; ?>&p_o_date=<?php echo $value->date; ?>&order_type=<?php echo $value->order_type; ?>&callorder=<?php echo $value->order_type;?>');" ><img width="20" height="20" src="<?php echo $System['URL']; ?>/public/images/edit.png"></a></td>
                    <td hidden="hidden" ><a><img width="20" height="20" src="<?php echo $System['URL']; ?>public/images/delete.png" onclick="rejectPendingOrder(<?php echo $value->purchase_order_id; ?>)"></a></td>
