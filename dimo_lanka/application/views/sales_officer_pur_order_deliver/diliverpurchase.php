     ...
     <tbody id='tn'>
        ...
        if ($extraData != '') {
            ...
            foreach ($extraData as $value) {
                ?>
         <tr id="tr_del_id_<?php echo $value->s_o_purchase_order_id;?>">
                  
                    <td><?php echo $value->s_o_purchase_order_id; ?></td>
                    ...
                    <td style="width: 10px"><img width="20" height="20" onclick="createDeliver(<?php echo $value->s_o_purchase_order_id; ?>);" src="<?php echo $System['URL']; ?>public/images/view.png" /></td>
                   
                    <td style="width: 10px"><img width="20" height="20" src="<?php echo $System['URL']; ?>public/images/reject.png" onclick="rejectOrderDetail(<?php echo $value->s_o_purchase_order_id; ?>)" /></td>
