                ...
                <td>
                    ...
                    <div id="entr_target" style="border: solid #206E94 2px; visibility: hidden">
                        ...
                        <table id="tbl_target" width="97%" class="SytemTable" align="center" cellpadding="10">
                            <thead>
                                <tr>
                                    <td hidden><input type="hidden" id="count" name="count"></td>
                                    <td>ASO Name</td>
                                    <td>Branch</td>
                            ...
                            <tbody>
                                <tr id="_1" name="_1">
                                    ...
                                    <td><input type="text" style="text-align: right" value="0" name="quantity_1" id="quantity_1" onkeyup="create_tot_qty();"></td>
