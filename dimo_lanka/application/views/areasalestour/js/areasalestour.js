...
//    $j('#fuelexpensesTable_body').empty();
    ...
    $j('#summery_table').append(
            ...
            + '<td>Bill Amount</td>'
            + '<td id="nar" style="width: 50px">Narration(with complete details)</td>'
            + '<td id="strat">Meter Rate(Start)</td>'
            + '<td id="end">Meter Rate(End)</td>'
            + '<td id="day">Meter Rate(Day)</td>'
            + '<td id="img">image</td>'
            + '</tr>'
            + '</thead>'
            );
        ...
        success: function(data) {
            ...
            jQuery.each(mealsArray, function(index, value) {
                ...
                if(mealsArray[rowcount][8]==''){
                   ...
                   // myimg='<img src="' + URL + 'expenses/' + mealsArray[rowcount][8] + '" style="width:30px;height:30px"></></a>';
                }
                        $j('#summery_table').append(
                        ...
                        + '<td id="end"></td>'
                        + '<td id="day"></td>'
                        + '<td id="img"  align="center">'+myimg+'</td>'
                        + '</tr>'
                        );
