...
<table class="SytemTable" style="width: 1800px">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center"><textarea style="border-color: blue"id="apm_comment_<?php echo $val->id_campaing?>"value=""><?php echo $val->apm_comment?></textarea> </td>
            
            
            <td style="text-align: center"><input id="done_button_<?php echo $val->id_campaing?>" type="button" value="Done" onclick="apmacceptfinishedcampaign(<?php echo $val->id_campaing?>);"></></td>
        </tr>
