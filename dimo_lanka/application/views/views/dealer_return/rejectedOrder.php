...
<center>
    <table>
        <tr>
            <td>Dealer Name:</td>
            <td>
                <input type="text" name="RejectdealerName" id="RejectdealerName" onfocus="get_reject_dealer_name();" placeholder="Select Dealer Name" autocomplete="off"/>
                <input type="hidden" name="Rejectdealer_id" id="Rejectdealer_id"  autocomplete="off"/>
            </td>
            <td>Account No:.</td>
            <td><input type="text" name="RejectaccountNo" onfocus="get_all_dealer_reject_AccountNo();" id="RejectaccountNo" placeholder="Select Account No" autocomplete="off"/></td>
        </tr>
        <tr>
            <td>Date From:</td>
        ...
        <tr>
            <td colspan="4" align="center"><input type="button" style="margin-left: 80px;"  name="search_btn" onclick="veiwRejectedOrder();" id="search_btn" value="Search"/></td>
        </tr>
    </table>
</center>
