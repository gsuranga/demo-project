...
//alert('aaa');
    ...
    $j.get('get_location', function (data) {
        ...
        $j.each(marks, function (index, value) {
            ...
            // for type 1 blue color dealer========== harshan ==========>>>>

            if (value.latitude !== '0' && value.longitude !== '0' && value.dealer_type == '1') {
                map.addMarker({
                    lat: value.latitude,
                    lng: value.longitude,
                    icon: URL + "public/images/blue-dot - 1.png",
                    draggable: false,
            ...
            // for type 2 red color dealer========== harshan ==========>>>>

            if (value.latitude !== '0' && value.longitude !== '0' && value.dealer_type == '2') {
                map.addMarker({
                    lat: value.latitude,
                    lng: value.longitude,
                    icon: URL + "public/images/red_dot.png",
                    draggable: false,
                    animation: google.maps.Animation.DROP,
                    title: 'Dealer name:-' + name + '\n' + 'Credit limit:-' + credit + '\n' + 'Dealer code:-' + code + '\n' + 'Delar shop name:-' + shop_name,
                    details: {
            ...
            // for type 3 green color dealer========== harshan ==========>>>>
            if (value.latitude !== '0' && value.longitude !== '0' && value.dealer_type == '3') {
                map.addMarker({
                    lat: value.latitude,
                    lng: value.longitude,
                    icon: URL + "public/images/green_dot.png",
                    draggable: false,
                    animation: google.maps.Animation.DROP,
                    title: 'Dealer name:-' + name + '\n' + 'Credit limit:-' + credit + '\n' + 'Dealer code:-' + code + '\n' + 'Delar shop name:-' + shop_name,
                    details: {
