...
<table width="100%" class="SytemTable" cellpadding="0" cellspacing="0" align="center">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a style="text-decoration: none;" href="drawIndexMeetingDecisionDiscussion?token_meeting_id=<?php echo $value->meeting_minute_id ;?>&token_account_no=<?php echo $value->account_no;?>"><img width="20" height="20" src="<?php echo $System['URL']; ?>public/images/subview3.png"></a></td>
        </tr> 
    <?php
            }
        } else {
