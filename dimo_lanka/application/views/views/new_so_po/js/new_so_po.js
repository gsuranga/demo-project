...
//                            + '</td>'
                            ...
                            + '<td style="text-align:center;color:' + color + '">'
                            + '<img style="width:20px;height:20px;cursor: pointer" id="dealer_pending_view_btn_' + purchase_order[i]['purchase_order_id'] + '" onclick="view_purchase_order(' + purchase_order[i]['purchase_order_id'] + ',2,' + purchase_order[i]['assigned'] + ',' + purchase_order[i]['amount'] + ',' + purchase_order[i]['discount_percentage'] + ',' + purchase_order[i]['current_vat'] + ','+purchase_order[i]['reason']+');" src=' + URL + 'images/view_s.png></>'
                            + '</td>'
                            + '</tr>'
            ...
            $j("<div> Are you sure you want to add this part ?</>").dialog({
                ...
                buttons: {
                    Yes: function() {
                        ...
                        $j("#dealer_pending_view_btn_" + pp).attr("onclick", "view_purchase_order(" + pp + "," + 2 + "," + assign_t + "," + amount + "," + dis_per + "," + cur_vat + ")");
