...
if (isset($_POST['year_picker'])) {
    ...
    $so_id = $_POST['txt_sales_officer_id'];
...
<table align="center"  style="alignment-adjust: middle" width="45%">
    <tr>
        <td >Sales Officer :</td>
        <td>
            <input style="width: 208px;" type="text" style="width: 220px;" <?php if ($typename == "Sales Officer") { ?> readonly="true" <?php } ?> id="txt_sales_officer" name="txt_sales_officer" placeholder="Sales Officer" autocomplete="off" onfocus="get_all_sales_officer_name();" value="<?php
            if ($typename == "Sales Officer") {
            ...
            ?>"/>
            <input type="hidden" id="txt_sales_officer_id" name="txt_sales_officer_id" value="<?php
            if ($typename == "Sales Officer") {
    ...
    <tr>
        <td>Account No :</td>
        <td>
            <input style="width: 208px;" type="text" style="width: 220px;" <?php if ($typename == "Sales Officer") { ?> readonly="true" <?php } ?> id="txt_sales_officer_acnt_no" name="txt_sales_officer_acnt_no" placeholder="Account No" autocomplete="off" onfocus="get_all_sales_officer_name_acnt_no();" value="<?php
            if ($typename == "Sales Officer") {
                echo $salesmanData[0]->sales_officer_account_no;
            } else {
                if (count($extraData[0]['form_data'])) {
...
<table align="center" class="actual_parts_count" width='100%' id="tbl_sales_man_wise_return_overall" >
    ...
    <tr>
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_apr = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_may = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_jun = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff"> 
            ...
            $returnHashQuantity_jul = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_aug = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_sep = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">  <?php
            ...
            $returnHashQuantity_oct = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_nov = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_dec = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_jan = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_feb = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $returnHashQuantity_mar = $_instance->getReturnHashQuantity($so_id, $start_date, $end_date);
    ...
    <tr>
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-04-01";
            $end_date = $year1 . "-04-30";
            $returnIndividualLine_apr = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-05-01";
            $end_date = $year1 . "-05-31";
            $returnIndividualLine_may = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-06-01";
            $end_date = $year1 . "-06-30";
            $returnIndividualLine_jun = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-07-01";
            $end_date = $year1 . "-07-31";
            $returnIndividualLine_jul = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-08-01";
            $end_date = $year1 . "-08-31";
            $returnIndividualLine_aug = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-09-01";
            $end_date = $year1 . "-09-30";
            $returnIndividualLine_sep = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-10-01";
            $end_date = $year1 . "-10-31";
            $returnIndividualLine_oct = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-11-01";
            $end_date = $year1 . "-11-30";
            $returnIndividualLine_nov = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = $year1 . "-12-01";
            $end_date = $year1 . "-12-31";
            $returnIndividualLine_dec = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = ($year1 + 1) . "-01-01";
            $end_date = ($year1 + 1) . "-01-31";
            $returnIndividualLine_jan = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = ($year1 + 1) . "-02-01";
            $end_date = ($year1 + 1) . "-02-29";
            $returnIndividualLine_feb = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
        ...
        <td style="background-color: #0A7EC5;text-align: center"><font style="color: #ffffff">
            ...
            $start_date = ($year1 + 1) . "-03-01";
            $end_date = ($year1 + 1) . "-03-31";
            $returnIndividualLine_mar = $_instance->getReturnIndividualLine($so_id, $start_date, $end_date);
