...
<table   align="center" class="SytemTable" width='100%'>
   <thead>
        ...
        <tr>
            ...
            <td style="background-color: #0A7EC5;"><font style=" color: #ffffff">Jan</td>
            ...
            <td style="background-color: #0A7EC5;"><font style=" color: #ffffff">Aug</td>
            <td style="background-color: #0A7EC5;"><font style=" color: #ffffff">Sep</td>
            ...
            <td style="background-color: #0A7EC5;"><font style=" color: #ffffff">Dec</td>
