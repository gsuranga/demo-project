...
<table width="50%" cellpadding="6" cellspacing="4" align="center" id="tbl_initial_review_date">
    <tr>
        <td><input type="text" id="txt_initial_date_comment" name="txt_initial_date_comment" placeholder="Wright a Comment..."/></td>
    </tr>
    <tr>
        <td>
            <table align="right" id="tbl_comment_btn">
                <tr>
                    <td>
