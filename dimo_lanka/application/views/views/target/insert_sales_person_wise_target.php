...
?>
<?php echo form_open('target/insertSalesOfficerWiseTarget', $form_attributes); ?>
...
<!--            <td hidden="hidden"><input type="hidden" name="txt_hidden_count" id="txt_hidden_count" value="<?php //echo $budget_amount;                          ?>"></td>-->
            ...
            <td><input type="button" id="btn_submit_budget" name="btn_submit_budget" value="Submit" onclick="insertSalesOfficerWiseTarget();"></td>     
