<?php ?>
<?php echo form_open('target/insertAreaWiseTarget'); ?>
            ...
            if ($extraData != '') {
                ...
                foreach ($extraData as $values) {
                    ...
                    <tr>
                        ...
                        <td width="30%"><input type="text" id="<?php echo 'txt_area_amount_' . $budget_amount ?>" name="<?php echo 'txt_area_amount_' . $budget_amount ?>" onclick="this.select();" value="0.00"></td>
                        <td width="30%"><input type="text" id="<?php echo 'txt_amended_amount_' . $amended_amount ?>" name="<?php echo 'txt_amended_amount_' . $amended_amount ?>" onclick="this.select();" value="0.00"></td>
                    </tr>
                    <?php
                    $area_id++;
                    $budget_amount++;
