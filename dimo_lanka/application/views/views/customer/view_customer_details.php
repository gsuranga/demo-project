...
<table  width="100%" class="SytemTable" cellpadding="0" cellspacing="0" id="tbl_all_dealers1">
    <thead>
        <tr>
            ...
            <td>Dealers & Garages Purchased parts</td>          
        ...
        if ($extraData != '') {
            foreach ($extraData as $value) {
                ...
                <tr>
                    ...
                    <td align="center"><img src="<?php echo $System['URL']; ?>public/images/Travel_details.png" style="widh:60px;height:20px;cursor:pointer" onclick="Dealers_Garages_Purchased_parts(<?php echo $value->vehicle_id; ?>);"></td>
