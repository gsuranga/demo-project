...
<!--            <td style="width: 10px">Reject</td>-->
     ...
     <tbody id='tn'>
        ...
        if($extraData['order'] != '') {
            ...
            foreach ($extraData['order'] as $value) {
                ?>
...
<!--                    <td style="width: 10px"><img width="20" height="20" src="<?php echo $System['URL']; ?>public/images/reject.png" onclick="rejectOrderDetail(<?php echo $value->purchase_order_id; ?>)" /></td>-->
        ...
        if($extraData['callOrder'] != '') {
            
            foreach ($extraData['callOrder'] as $value) {
                ?>
               <tr id="tr_del_id_<?php echo $value->purchase_order_id;?>">
                  
                    <td><?php echo $value->purchase_order_id.'<br>Call Order'; ?></td>
...
<!--                    <td align="right"><?php echo $value->total_discount; ?></td>-->
                    <td align="right"><?php echo $value->amount; ?></td>
                    <td style="width: 10px"><img width="20" height="20" onclick="createDeliverCall(<?php echo $value->purchase_order_id; ?>);" src="<?php echo $System['URL']; ?>public/images/view.png" /></td>
