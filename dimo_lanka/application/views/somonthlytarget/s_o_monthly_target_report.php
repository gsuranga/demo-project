...
$print_report = array(
    ...
    'onclick' => 'reportsToExcel(tbl_report_s_o_monthly_target,tbl_report_s_o_monthly_target);'
);
$target_month = array(
    'id' => 'target_month',
    'name' => 'target_month',
        ...
        <td>
            <table align="right">
                <tr>
                    ...
                    <td>
                        <?php echo form_input($print_report); ?>
                    </td>
                </tr>
            </table>
        </td>
...
<table width="100%" class="SytemTable" cellpadding="0" cellspacing="0" id="tbl_report_s_o_monthly_target" name="tbl_report_s_o_monthly_target">
    <thead>
        <tr id="ok">
