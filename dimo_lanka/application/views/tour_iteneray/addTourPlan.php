...
<table align="right" style="padding-left: 25px;">
            <tr>
                <td><b> Target Collection</b></td>
            <td><input type="text" id="targetCol" name="targetCol" /></td>
            ...
            <tr>      
            <td><b>Target Sales</b></td>
            <td><input type="text" id="targetSales" name="targetSales" /></td></tr>
            
            
        </table>
<table width="50%" class="SytemTable" align="left" id="tbl_purchaseorder" cellpadding="10">
    <thead>
        <tr>
            <td></td>
            <td>Customer Type</td>
    ...
    <tbody id="tbody1">
        <tr  name="1" id="1">
            ...
            <td><select name="type_1"> <option selected>Type Of Customer</option><option value="Dealers">Dealers</option><option value="Fleet Owners">Fleet Owners</option></select></td>
            
            <td><input type="text" name="dealer_Acco_1" id="dealer_Acco_1" onfocus="dealer_Acco();" autocomplete="off" placeholder="Dealer Acc. No"/> </td> 
              <input type="hidden" name="dealer_Acco_id_1" id="dealer_Acco_id_1"/> 
