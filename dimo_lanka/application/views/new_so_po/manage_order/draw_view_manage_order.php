        ...
        <td>
            <div id="tabs">
                <ul>
                    ...
                    <li><a href="#saved_purchase_order"><span>Special Promotion</span></a></li>
                    <!--<li><a href="#assign_purchase_order"><span>Special price  Promotion</span></></a></li>-->
                ...
                <!--                <div class="Tab_content" id="assign_purchase_order"  >
                                ...
                                <td>Order</td>
                                        ...
                                        <tbody id="saved_purchase_order_table">
