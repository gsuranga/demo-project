...
//        redirect('area/drawIndexArea');
    ...
    public function getDealerPurchaseOrders() {
        ...
        $this->load->model('dealer_purchase_order/dealer_purchase_order_model');
        $data_set = array();
        $viewAcceptedOrders = $this->dealer_purchase_order_model->viewAllAcceptedOrders($id);
    ...
    public function getPurchaseOrderDetail() {
        ...
        $this->load->model('dealer_purchase_order/dealer_purchase_order_model');
        $data_set2 = array();
        $purchaseOrderDetails = $this->dealer_purchase_order_model->viewAllAcceptedPurchaseOrderDetails($get);
        $data_set = array(
            $purchaseOrderDetails,
        );
        //  array_push($data_set2, $viewacceptOrderDetail);
        header('Content-type: application/json');
        $json_encode = json_encode($data_set);
        print_r($json_encode);
        return $json_encode;
    }
