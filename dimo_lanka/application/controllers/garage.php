...
//        $this->form_validation->set_rules('garage_account_no', 'Garage Account No', 'required');
        ...
        $this->form_validation->set_rules('txt_part_cityReg_id_1', 'Town', 'required');
...
// add part type
    public function get_all_vehicle_part_type() {
        ...
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->getAllPartType());
    }
...
//    }
    ...
    public function get_city() {
        ...
        $result = $this->garage_model->getAllCity($q, $column);
        $no_result = array('label' => 'no result found');
        if (count($result) > 0) {
            echo json_encode($result);
        } else {
    ...
    public function get_all_vehicle_type() {
        ...
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->getAllVehicleType());
    }

    public function get_all_indian_vehicle_type() {
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->get_all_indian_vehicle_type());
    }

        public function get_all_vehicle_brands() {
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->get_all_vehicle_type());
    }
    public function get_all_indian_type() {
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->getindianbarndsDetails());
    }
    ...
    public function get_all_vehicle() {
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->getAllVehicleModel());
    }
...
//    }
    ...
    public function get_all_vehicle_repair() {
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->getAllVehicleRepair());
    }
...
//    }
    ...
    public function get_al_vehicle_sub_model() {
        $this->load->model('garage/garage_model');
        echo json_encode($this->garage_model->getAllVehicleSubModel());
    }
