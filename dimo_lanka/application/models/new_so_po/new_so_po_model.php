...
Order BY (sum(tbl_dealer_sales.qty)) DESC";
    ...
    public function add_new_purchase_order($data_array) {
        ...
        $dealerDetails = $this->delar_model->getDealerDetails("delar_id", $data_array['dealerAccountNo']);
        ...
        $data1 = array(
            "date" => date('Y-m-d'),
            "time" => date('H:i:s'),
            // 'dealer_purchase_order_id' => $_REQUEST['dealerPurchaseOrderID'],
