...
class kit_promotion_model extends C_Model {
    ...
    //drawAso1
    public function drawAso1(){
       $sql = "SELECT ts.sales_officer_name,ts.sales_officer_id,tb.branch_name FROM tbl_sales_officer ts "
               . "INNER JOIN tbl_branch tb on tb.branch_id = ts.branch_id";
