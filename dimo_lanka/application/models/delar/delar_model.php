...
WHERE
    ...
    td.delar_shop_name,
    td.discount_percentage,
    td.date_account_open,
    td.delar_code,
    td.status,
    td.dealer_time_stamp,
    td.so_update_status,
    td.dob,
    td.religion,
    td.nic_no,
    td.passport_no,
    td.business_started_date,
    td.period_with_dimo,
    td.manager_name,
    td.p_number,
    td.business_address,
...
WHERE
    ...
    //new edit for tab delar update-------------------------------
    public function viewAllDealerinfor($delarId) {
...
WHERE
    td.status = '1'
        and td.so_update_status = 0 and td.delar_id = '".$delarId."'  ";
        return $this->db->mod_select($sql);
    ...
    public function createDelarnew($data_Array, $yes, $no) {
      ...
      $where = array(
       ...
       $data = array(
            ...
            'delar_num' => $data_Array['delar_num'],
          ...
          'religion' => $data_Array['cmb_religion_type'],
           ...
           'business_address' => $data_Array['address_mgr'],
            ...
            'txt_remarksO' => $data_Array['txt_remarks'],
            'status' => 1,
            'so_update_status' => 0
        );
      // print_r($data);
    ...
    */
    ...
    public function updateDealer($data_Array) {
        ...
        $data = array(
            'delar_code' => $data_Array['dealer_code'],
            'delar_name' => $data_Array['m_delar_name'],
            'delar_num' => $data_Array['m_delar_num'],
            'dealer_type' => $data_Array['type'],
            'delar_account_no' => $data_Array['m_delar_account_no'],
            'discount_percentage' => $data_Array['Cedit_limit'],
            'delar_shop_name' => $data_Array['m_delar_shop_name'],
        ...
        // print_r($where);
        //print_r($data);
        $query = $this->db->get_where('tbl_dealer', array('delar_code' => $data_Array['dealer_code'], 'delar_name' => $data_Array['m_delar_name'], 'delar_num' => $data_Array['m_delar_num'], 'delar_account_no' => $data_Array['m_delar_account_no'], 'delar_shop_name' => $data_Array['m_delar_shop_name'], 'sales_officer_id' => $data_Array['sales_officer_id'], 'longitude' => $data_Array['longs'], 'latitude' => $data_Array['lats'], 'discount_percentage' => $data_Array['Cedit_limit']));
