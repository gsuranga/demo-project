...
//    new edit 2015/11/17
    function viewDelarCallOrder(){
         $sql = "select * from tbl_dealer_purchase_order tsopo Left Join tbl_sales_officer tso on tsopo.sales_officer_id=tso.sales_officer_id join tbl_dealer td on tsopo.dealer_id=td.delar_id join tbl_branch tb on td.branch_id=tb.branch_id where tsopo.status='1'  and tsopo.order_type='1' and tsopo.dealer_id=$this->dealerId " ;
...
//    updateDelarPurchaseCall
    
    function updateDelarPurchaseCall($m,$j,$k){
        echo $k;
          $data12 = array(
            "amount" =>$m,
            "total_discount"=>$j,
