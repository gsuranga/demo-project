 ...
 */
class outlets extends C_Controller {
    ...
    function insertOutlet() {
        ...
        if ($this->form_validation->run()) {
            ...
            $insertUserType = $this->outlet_model->insertOutlet1($this->input->post());
            if ($insertUserType) {
                $this->session->set_flashdata('insert_outlet', '<br><span style="font-size: 13px;background-color: #FFFFFF;color:#00cc00;border:solid 1px #00cc00;padding:2px;border-radius: 5px 5px 5px 5px">Successfully Added a Outlet</spam>');
            } else {
    ...
    function drawOutletView() {
        $this->load->model('outlet/outlet_model');
        $viewoutlet = $this->outlet_model->viewAllOutlet();
    ...
    function drawOutletDetails($id) {
        $this->load->model('outlet/outlet_model');
        $viewoutlet = $this->outlet_model->viewAllOutletDetails($id);
    ...
    function drawOutlet_Division_Details($id) {
        $this->load->model('outlet/outlet_model');
        $viewoutletDivision = $this->outlet_model->viewAllOutlet_Division_Details($id);
    ...
    function deleteOutlet() {
        ...
        $outletType = $this->outlet_model->deleteOutlet($id);
    ...
    function viewOutletDetailsFromId($id) {
        $this->load->model('outlet/outlet_model');
        $fetchAllOutlet = $this->outlet_model->viewAllOutletFromID1($id);
    ...
    function viewBranchDetailsFromId($id) {
        $this->load->model('outlet/outlet_model');
        $fetchAllOutlet = $this->outlet_model->viewAllBranchFromID1($id);
    ...
    function viewManageDivisionDetailsFromId($id) {
        $this->load->model('outlet/outlet_model');
        $fetchDivision = $this->outlet_model->viewAllDivisionFromID2($id);
    ...
    function viewDivisionListFromBranchID($id) {
        $this->load->model('outlet/outlet_model');
        $fetchAllBranchDivision = $this->outlet_model->viewAllDivisionFromID1($id);
    ...
    function viewBranchDetailsFromBranchID($id) {
        $this->load->model('outlet/outlet_model');
        $fetchAllBranchDetails = $this->outlet_model->viewBranchDetailsFromID1($id);
    ...
    function drawOutletManageView($id) {
        $this->load->model('outlet/outlet_model');
        $fetchAllOutlet = $this->outlet_model->viewAllOutletDetails($id);
    ...
    function updateOutlet() {
        ...
        $outlet = $this->outlet_model->updateOutlet($this->input->post());
        if ($outlet) {
            $this->session->set_flashdata('update_outlet', '<br><span style="font-size: 13px;background-color: #FFFFFF;color:#00cc00;border:solid 1px #00cc00;padding:2px;border-radius: 5px 5px 5px 5px">Successfully Updated Outlet</spam>');
        } else {
    ...
    function updateBranch() {
        ...
        $updateBranch = $this->outlet_model->updateBranch1($this->input->post());
        if ($updateBranch) {
    ...
    function updateDivision() {
        ...
        $id_outlet_has_branch = $this->input->post('id_outlet_has_branch');
        $updateBranch = $this->outlet_model->updateDivision1($this->input->post());
        if ($updateBranch) {
    ...
    function allOutletCategorytoListBox() {
        $this->load->model('outlet/outlet_model');
        $fetchAllEmployee = $this->outlet_model->fetchFromAnyTable("tbl_outlet_category", null, null, null, 10000, 0, "RESULTSET", array('outlet_category_status' => 1), null);
    ...
    function allTeritorytoListBox() {
        $this->load->model('outlet/outlet_model');
        $fetchAllEmployee = $this->outlet_model->fetchFromAnyTable("tbl_territory", null, null, null, 10000, 0, "RESULTSET", null, null);
        $pushdata = array('outlet' => $fetchAllEmployee);
    ...
    function allDivisionListBox() {
        $this->load->model('outlet/outlet_model');
        $fetchAllEmployee = $this->outlet_model->fetchFromAnyTable("tbl_division", null, null, null, 10000, 0, "RESULTSET", null, null);
        $pushdata = array('outlet' => $fetchAllEmployee);
...
//auto complete
    public function getDivisionNames() {
        ...
        $result = $this->outlet_model->getDivisionNames($q, $column);
...
//        echo json_encode($result);
        ...
        $this->load->model('outlet/outlet_model');
        $column = array('territory_name', 'id_territory');
        $result = $this->outlet_model->getOutletNameByEmp($q, $column);
        echo json_encode($result);
    }
    ...
    function viewOutletByFilterKey($Data) {
        $this->load->model('outlet/outlet_model');
        $viewOutlet = $this->outlet_model->viewOutletByFilterKey($Data);
        $this->template->draw('outlet/outletView', false, $viewOutlet);
    }
