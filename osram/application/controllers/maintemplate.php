                                ...
                                <ul>
                                    ...
                                    <?php if ($user_type == "Admin") { ?>
                                        <li><a href="#">User Type</a> 
                                            <ul>
                                                <li><a href="<?php echo $System['URL']; ?>user_type/drawindexUserType">Register User Type</a></li>
                                            </ul>
                                        </li>
                                    <?php } ?>
                                    <?php if ($user_type == "Admin") { ?>
                            ...
                            <li> <a href="#">Registration</a>
                                <ul>
                                    ...
                                    <li><a href="#">Route</a> 
                                        <ul>                                                 
                                            <li>
                                                <a href="<?php echo $System['URL']; ?>routeplane/drawAddRoutePlan">Register Route Plan</a>
                                            </li>
                                            <li>
