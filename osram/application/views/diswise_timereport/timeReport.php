...
<html>
    ...
    <form action="<?php echo base_url() ?>diswise_timereport/drawTimeReportIndex" method="post" name="disTimeRpt" id="disTimeRpt">
        ...
        <table align='center'>
            ...
            <tr>
                ...
                <td><input type="hidden" id="time_report_employee_id" name="time_report_employee_id"/></td>
            </tr>
