 ...
 */
?>
<form action="<?php echo base_url()?>reports/inserttarter" method="post">
...
<table>
    ...
    <tr>
        <td></td>
        <td><?php echo form_error('txt_ter_name'); ?></td> 
        <td></td>
...
<table>
    <tr>
        <td>
            <?php echo $this->session->flashdata('insert_terreyr_wise'); ?>
        </td>
    </tr>
</table>