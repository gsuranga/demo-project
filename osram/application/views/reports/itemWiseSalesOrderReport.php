...
<html>
    ...
    <body>
        ...
        <form action="<?php echo base_url() ?>reports/itemWiseSalesOrderReportIndex?token=<?php echo md5(time()); ?>" method="post">        
            ...
            <table align="center">
                ...
                <tr>
                    <td>Start Date</td>
                    <td><input type="text" name="txt_st_date" id="txt_st_date" value="" autocomplete="off" readonly="true"></td>
                </tr>
                <tr>
                    <td>End Date</td>
                    <td><input type="text" name="txt_en_date" id="txt_en_date" value="" autocomplete="off" readonly="true"></td>
                </tr>
...
<!--                    <td><label>Select a territory :</label></td>
            ...
            <table align="right">    
                <tr>
                    ...
                    <td><input type="button" value="To Excel" onclick="reportsToExcel('sales_report', 'item_wise_sales_report');" /></td>
                    <td><input type="hidden" id="session" name="session" value="<?php echo $this->session->userdata('id_user') ?>" /></td>
                    <td><input type="hidden" id="topic" name="topic" value="<?php echo 'Item Wise Sales Report' ?>" /></td>
                </tr>
            </table>
            <div>
...
//                    echo $id_physical_place;
                    ...
                    foreach ($dataPacket as $value) {
                        $prodcutDetail = $_instance->getProdcutDetail($value);
                        $slaesQty = $_instance->getSlaesQty($value, $id_physical_place);
//                        print_r($slaesQty);
                        ?>
                        <tr>
                            <td><?php echo $value; ?></td>
                            <td><?php echo $prodcutDetail[0]['item_no']; ?></td>
